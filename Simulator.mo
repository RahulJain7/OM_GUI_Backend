package Simulator
    ...
    package Thermodynamic_Functions
      ...
      algorithm
        ...
        if T > 298.15 then
          ...
          Ent := SH / 1000 + Ent + HV(HOV, Tc, 298.15);
        else
          while Temp > T loop
            Ent := Ent + VapCpId(VapCp, Temp) * 0.01;
            Temp := Temp - 0.01;
      ...
      algorithm
        ...
        if T > Tref then
          while T > Temp loop
            Entr := Entr + VapCpId(VapCp, Temp) * 0.01 / Temp;
            Temp := Temp + 0.01;
          end while;
        else
          while T < Temp loop
        ...
        if x > 0 and y > 0 then
          Sliq := AS + Entr - R * log(P / Pref) - R * log(x) - HV(HOV, Tc, Tb) / Tb;
          Svap := AS + Entr - R * log(P / Pref) - R * log(y);
        elseif x == 0 then
          Sliq := 0;
          Svap := AS + Entr - R * log(P / Pref) - R * log(y);
        elseif y == 0 then
  ...
  model Streams
    ...
    model Material_Stream
      ...
      Files.Connection.matConn inlet(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Files.Connection.matConn outlet(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
//Connector equations
      inlet.P = P;
      inlet.T = T;
...
model Energy_Stream
      Real enFlo;
      Files.Connection.enConn inlet annotation(Placement(visible = true, transformation(origin = {-100, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Files.Connection.enConn outlet annotation(Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
//connector equation
      enFlo = inlet.enFlo;
      enFlo = outlet.enFlo;
  ...
  package Unit_Operations
    ...
    model Mixer
      ...
      //================================================================================
      Files.Connection.matConn inlet1(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, 86}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 88}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn inlet2(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Files.Connection.matConn inlet3(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn inlet4(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, -22}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -20}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Files.Connection.matConn inlet5(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, -54}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -54}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Simulator.Files.Connection.matConn inlet6(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, -86}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, -88}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Files.Connection.matConn outlet(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {98, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {98, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
//Connector equation
      inlet1.P = inP[1];
      inlet1.T = inT[1];
      inlet1.mixMolFlo = inMolFlo[1];
      inlet1.mixMolEnth = inTotMolEnth[1];
      inlet1.mixMolEntr = inTotMolEntr[1];
      inlet1.mixMolFrac[:] = inCompMolFrac[1, :];
      inlet1.vapPhasMolFrac = inVapPhasMolFrac[1];
      inlet2.P = inP[2];
      inlet2.T = inT[2];
      inlet2.mixMolFlo = inMolFlo[2];
      inlet2.mixMolEnth = inTotMolEnth[2];
      inlet2.mixMolEntr = inTotMolEntr[2];
      inlet2.mixMolFrac[:] = inCompMolFrac[2, :];
      inlet2.vapPhasMolFrac = inVapPhasMolFrac[2];
      inlet3.P = inP[3];
      inlet3.T = inT[3];
      inlet3.mixMolFlo = inMolFlo[3];
      inlet3.mixMolEnth = inTotMolEnth[3];
      inlet3.mixMolEntr = inTotMolEntr[3];
      inlet3.mixMolFrac[:] = inCompMolFrac[3, :];
      inlet3.vapPhasMolFrac = inVapPhasMolFrac[3];
      inlet4.P = inP[4];
      inlet4.T = inT[4];
      inlet4.mixMolFlo = inMolFlo[4];
      inlet4.mixMolEnth = inTotMolEnth[4];
      inlet4.mixMolEntr = inTotMolEntr[4];
      inlet4.mixMolFrac[:] = inCompMolFrac[4, :];
      inlet4.vapPhasMolFrac = inVapPhasMolFrac[4];
      inlet5.P = inP[5];
      inlet5.T = inT[5];
      inlet5.mixMolFlo = inMolFlo[5];
      inlet5.mixMolEnth = inTotMolEnth[5];
      inlet5.mixMolEntr = inTotMolEntr[5];
      inlet5.mixMolFrac[:] = inCompMolFrac[5, :];
      inlet5.vapPhasMolFrac = inVapPhasMolFrac[5];
      inlet6.P = inP[6];
      inlet6.T = inT[6];
      inlet6.mixMolFlo = inMolFlo[6];
      inlet6.mixMolEnth = inTotMolEnth[6];
      inlet6.mixMolEntr = inTotMolEntr[6];
      inlet6.mixMolFrac[:] = inCompMolFrac[6, :];
      inlet6.vapPhasMolFrac = inVapPhasMolFrac[6];
      outlet.P = outP;
      outlet.T = outT;
...
//Energy balance
    ...
    model Heater
      ...
      //========================================================================================
      Files.Connection.matConn inlet(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Files.Connection.matConn outlet(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Files.Connection.enConn energy annotation(Placement(visible = true, transformation(origin = {0, -100}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {0, -98}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      //=============================================================================================
    equation
//connector equations
      inlet.P = inP;
...
//material balance
      ...
      reqPow = inMolFlo * (outMixMolEnth - inMixMolEnth) / eff; 
//energy balance
      inP + pressInc = outP;
//pressure calculation
      inT + tempInc = outT;
...
//temperature calculation
    ...
    model Shortcut_Column
      ...
      Real P, T;//for thermodynamic models
     
      parameter String condType "Condenser Type";
      parameter Integer NOC "number of compounds", HKey, LKey;
      parameter Simulator.Files.Chemsep_Database.General_Properties comp[NOC];
  Files.Connection.matConn feed(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {-100, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Files.Connection.matConn distillate(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {100, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, 50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  Files.Connection.matConn bottoms(connNOC = NOC) annotation(Placement(visible = true, transformation(origin = {100, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {100, -50}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
...
//1 stands for mixture
    ...
    package heater1
      ...
      model heat
        ...
        parameter data.Water wat;
        //instantiation of water
        Unit_Operations.Heater heater1(pressDrop = 101325, eff = 1, NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-28, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms inlet(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-74, 10}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms outlet(NOC = 3, comp = {meth, eth, wat}, T(start = 353), compMolFrac(start = {{0.33, 0.33, 0.34}, {0.24, 0.31, 0.43}, {0.44, 0.34, 0.31}}), P(start = 101325)) annotation(Placement(visible = true, transformation(origin = {24, 12}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Streams.Energy_Stream energy annotation(Placement(visible = true, transformation(origin = {-60, -38}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(heater1.outlet, outlet.inlet) annotation(Line(points = {{-18, 12}, {14, 12}}));
        connect(energy.outlet, heater1.energy) annotation(Line(points = {{-50, -38}, {-28, -38}, {-28, 2}, {-28, 2}}));
        connect(inlet.outlet, heater1.inlet) annotation(Line(points = {{-64, 10}, {-38, 10}, {-38, 12}, {-38, 12}}));
      equation
...
//heat removed
      ...
      model cool
        ...
        parameter data.Water wat;
        //instantiation of water
        Unit_Operations.Cooler cooler1(pressDrop = 0, eff = 1, NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-4, 18}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
        ms inlet(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-72, 18}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
        ms outlet(NOC = 3, comp = {meth, eth, wat}, T(start = 351), compMolFrac(start = {{0.33, 0.33, 0.34}, {0.29, 0.33, 0.37}, {0.5, 0.32, 0.16}}), P(start = 101325)) annotation(Placement(visible = true, transformation(origin = {58, 18}, extent = {{-12, -12}, {12, 12}}, rotation = 0)));
        Streams.Energy_Stream energy annotation(Placement(visible = true, transformation(origin = {33, -43}, extent = {{-13, -13}, {13, 13}}, rotation = 0)));
      equation
        connect(cooler1.energy, energy.inlet) annotation(Line(points = {{-4, 4}, {-4, 4}, {-4, -44}, {20, -44}, {20, -44}}));
        connect(cooler1.outlet, outlet.inlet) annotation(Line(points = {{10, 18}, {44, 18}, {44, 18}, {46, 18}}));
        connect(inlet.outlet, cooler1.inlet) annotation(Line(points = {{-60, 18}, {-20, 18}, {-20, 18}, {-18, 18}}));
      equation
        inlet.compMolFrac[1, :] = {0.33, 0.33, 0.34};
//mixture molar composition
        inlet.P = 101325;
...
//input mixture molar enthalpy is taken from outlet stream of  msTPbbp solution or you can use values of inP and inT and calculate by simulating material stream model.
      ...
      model valve
        ...
        parameter data.Water wat;
        //instantiation of water
        Unit_Operations.Valve valve1(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {0, 4}, extent = {{-14, -14}, {14, 14}}, rotation = 0)));
        Simulator.Test.valve1.ms inlet(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-74, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms outlet(NOC = 3, comp = {meth, eth, wat}, T(start = 352), compMolFrac(start = {{0.33, 0.33, 0.34}, {0.26, 0.32, 0.40}, {0.47, 0.34, 0.18}})) annotation(Placement(visible = true, transformation(origin = {66, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(inlet.outlet, valve1.inlet) annotation(Line(points = {{-64, 4}, {-14, 4}}));
        connect(valve1.outlet, outlet.inlet) annotation(Line(points = {{14, 4}, {56, 4}}));
        inlet.compMolFrac[1, :] = {0.33, 0.33, 0.34};
//mixture molar composition
        inlet.P = 202650;
//input pressure
...
//input molar flow
    ...
    package adia_comp1
      model ms
        ...
        parameter data.Water wat;
        //instantiation of water
        extends Simulator.Streams.Material_Stream(NOC = 3, comp = {meth, eth, wat}, totMolFlo(each start = 30), compMolFrac(each start = 0.33), T(start = sum(comp.Tb) / NOC));
        //material stream extended in which parameter NOC an dcomp are given values and other variables are given start values
        extends Simulator.Files.Thermodynamic_Packages.Raoults_Law;
        //thermodynamic package Raoults law is extended
      end ms;
      ...
      model maintest
        //Use hybrid nonlinear solver
        extends Unit_Operations.Adiabatic_Compressor(reqPow(start = 36962), tempInc(start = 3.17));
...
//pressure increase
      ...
      model adia_comp
        ...
        parameter data.Water wat;
        //instantiation of water
        compres adiabatic_Compressor1(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-9, 7}, extent = {{-23, -23}, {23, 23}}, rotation = 0)));
        Simulator.Test.adia_comp1.ms inlet(NOC = 3, comp = {meth, eth, wat}, totMolFlo(each start = 30), compMolFrac(each start = 0.33), T(start = sum(comp.Tb) / NOC)) annotation(Placement(visible = true, transformation(origin = {-78, 8}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms outlet(NOC = 3, comp = {meth, eth, wat}, T(start = 352), compMolFrac(start = {{0.33, 0.33, 0.34}, {0.26, 0.32, 0.40}, {0.47, 0.34, 0.11}})) annotation(Placement(visible = true, transformation(origin = {58, 6}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Simulator.Streams.Energy_Stream power annotation(Placement(visible = true, transformation(origin = {-50, -56}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(power.outlet, adiabatic_Compressor1.energy) annotation(Line(points = {{-40, -56}, {-10, -56}, {-10, -16}, {-8, -16}}));
        connect(adiabatic_Compressor1.outlet, outlet.inlet) annotation(Line(points = {{14, 6}, {48, 6}, {48, 6}, {48, 6}}));
        connect(inlet.outlet, adiabatic_Compressor1.inlet) annotation(Line(points = {{-68, 8}, {-32, 8}}));
        inlet.compMolFrac[1, :] = {0.33, 0.33, 0.34};
//mixture molar composition
        inlet.P = 202650;
//input pressure
...
//pressure increase
    ...
    package mix1
      ...
      model mix
        ...
        parameter data.Methanol meth;
        parameter data.Water wat;
        ms ms1(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-84, 88}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms ms2(NOC = 3) annotation(Placement(visible = true, transformation(origin = {-84, 58}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms ms3(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-86, 24}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms ms4(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-84, -16}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms ms5(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-84, -52}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        ms ms6(NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-82, -86}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Unit_Operations.Mixer mixer1(NOC = 3, comp = {meth, eth, wat}, outPress = "Inlet_Average") annotation(Placement(visible = true, transformation(origin = {0, 2}, extent = {{-26, -26}, {26, 26}}, rotation = 0)));
        ms out1(NOC = 3, comp = {meth, eth, wat}, T(start = 354), totMolFlo(start = 1600)) annotation(Placement(visible = true, transformation(origin = {62, 2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      equation
        connect(mixer1.outlet, out1.inlet) annotation(Line(points = {{26, 2}, {52, 2}, {52, 2}, {52, 2}}));
        connect(ms6.outlet, mixer1.inlet6) annotation(Line(points = {{-72, -86}, {-34, -86}, {-34, -20}, {-26, -20}, {-26, -20}}));
        connect(ms5.outlet, mixer1.inlet5) annotation(Line(points = {{-74, -52}, {-44, -52}, {-44, -12}, {-26, -12}, {-26, -12}}));
        connect(ms4.outlet, mixer1.inlet4) annotation(Line(points = {{-74, -16}, {-50, -16}, {-50, -2}, {-26, -2}, {-26, -4}}));
        connect(ms3.outlet, mixer1.inlet3) annotation(Line(points = {{-76, 24}, {-50, 24}, {-50, 6}, {-26, 6}, {-26, 8}}));
        connect(ms2.outlet, mixer1.inlet2) annotation(Line(points = {{-74, 58}, {-44, 58}, {-44, 16}, {-26, 16}, {-26, 16}}));
        connect(ms1.outlet, mixer1.inlet1) annotation(Line(points = {{-74, 88}, {-26, 88}, {-26, 25}}));
      equation
        ms1.P = 101325;
        ms2.P = 202650;
        ms3.P = 126523;
    ...
    model mix2
      ...
      parameter data.Methanol meth;
      parameter data.Water wat;
      parameter data.Ethane prop;
      Unit_Operations.Mixer mix(outPress = "Inlet_Average", NOC = 3, comp = {meth, eth, wat}) annotation(Placement(visible = true, transformation(origin = {-1, -7}, extent = {{-19, -19}, {19, 19}}, rotation = 0)));
      cooler1.ms ms1 annotation(Placement(visible = true, transformation(origin = {-74, 22}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      cooler1.ms out1(T(start = 321), compMolFrac(start = {{0.33, 0.33, 0.34}, {0.33, 0.33, 0.34}, {0, 0, 0}})) annotation(Placement(visible = true, transformation(origin = {64, -2}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    equation
      connect(mix.outlet, out1.inlet) annotation(Line(points = {{18, -8}, {34, -8}, {34, -2}, {54, -2}, {54, -2}}));
      connect(ms1.outlet, mix.inlet1) annotation(Line(points = {{-64, 22}, {-36, 22}, {-36, 10}, {-20, 10}, {-20, 10}}));
    equation
      ms1.P = 202650;
      mix.inP[2] = 0;
      mix.inP[3] = 0;
      ...
      mix.inMolFlo[5] = 0;
      mix.inMolFlo[6] = 0;
      ms1.compMolFrac[1, :] = {0.3, 0.3, 0.3};
      mix.inCompMolFrac[2, :] = {0, 0, 0};
      mix.inCompMolFrac[3, :] = {0, 0, 0};
      mix.inCompMolFrac[4, :] = {0, 0, 0};
      mix.inCompMolFrac[5, :] = {0, 0, 0};
      mix.inCompMolFrac[6, :] = {0, 0, 0};
      mix.inTotMolEnth[2] = 0;
      mix.inTotMolEnth[3] = 0;
      mix.inTotMolEnth[4] = 0;
      mix.inTotMolEnth[5] = 0;
      mix.inTotMolEnth[6] = 0;
      mix.inlet2.mixMolEntr = 0;
      mix.inlet3.mixMolEntr = 0;
      mix.inlet4.mixMolEntr = 0;
      mix.inlet5.mixMolEntr = 0;
      mix.inlet6.mixMolEntr = 0;
      mix.inlet2.vapPhasMolFrac = 0;
      mix.inlet3.vapPhasMolFrac = 0;
      mix.inlet4.vapPhasMolFrac = 0;
      mix.inlet5.vapPhasMolFrac = 0;
      mix.inlet6.vapPhasMolFrac = 0;
    end mix2;
...
model ms
  ...
  extends Simulator.Files.Thermodynamic_Packages.Raoults_Law;
      ...
      //use non linear solver homotopy for solving
        Simulator.Test.shortcut.Shortcut shortcut(HKey = 2, LKey = 1, mixMolFrac(start = {{0.5, 0.5}, {0.01, 0.99}, {0.99, 0.01}}) , minN(start = 10.1859), theta(start = 1, min = 1), minR(start = 2, min = 0)) annotation(Placement(visible = true, transformation(origin = {2, 4}, extent = {{-30, -30}, {30, 30}}, rotation = 0)));
        ms feed(compMolFrac(start = {{0.5, 0.5}, {0.34, 0.65}, {0.56, 0.44}})) annotation(Placement(visible = true, transformation(origin = {-74, 4}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ms bottoms(T(start = 383.08), compMolFrac(start = {{0.01, 0.99}, {0.01, 0.99}, {0, 0}})) annotation(Placement(visible = true, transformation(origin = {76, -28}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    ms distillate(T(start = 353.83), compMolFrac(start = {{0.99, 0.01},{0.99,0.01}, {0, 0}})) annotation(Placement(visible = true, transformation(origin = {76, 38}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
        connect(shortcut.distillate, distillate.inlet) annotation(Line(points = {{32, 20}, {50, 20}, {50, 38}, {66, 38}}));
        connect(shortcut.bottoms, bottoms.inlet) annotation(Line(points = {{32, -10}, {51, -10}, {51, -28}, {66, -28}}));
        connect(feed.outlet, shortcut.feed) annotation(Line(points = {{-64, 4}, {-30, 4}, {-30, 4}, {-28, 4}}));
